...
namespace Parang {
	...
	BOOL BasicMeshObject::InitPipelineState()
	{
		...
		UINT compileFlags = 0;
#endif
		if (FAILED(D3DCompileFromFile(L"./Shaders/BasicShaders.hlsl", nullptr, nullptr, "VSMain", "vs_5_0", compileFlags, 0, &pVertexShader, nullptr)))
		{
			__debugbreak();
		}
		if (FAILED(D3DCompileFromFile(L"./Shaders/BasicShaders.hlsl", nullptr, nullptr, "PSMain", "ps_5_0", compileFlags, 0, &pPixelShader, nullptr)))
		{
			__debugbreak();
		}
	...
	void BasicMeshObject::Draw(ID3D12GraphicsCommandList* pCommandList)
	{
		// set RootSignature
