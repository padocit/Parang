...
extern "C" { __declspec(dllexport) extern const char* D3D12SDKPath = u8"..\\..\\..\\..\\Parang\\D3D12\\x64\\"; }
...
ULONGLONG g_PrevFrameCheckTick = 0;
ULONGLONG g_PrevUpdateTick = 0;
...
void RunGame()
{
	...
	// game business logic
	if (CurTick - g_PrevUpdateTick > 16)
	{
		// Update Scene with 60FPS
		Update();
		g_PrevUpdateTick = CurTick;
	}
